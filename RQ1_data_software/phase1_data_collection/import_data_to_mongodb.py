...
FILE_COLLECTION_MAP = {
    'rosa_new_data.json': 'ROSAnswers',
    'rosd_new_data.json': 'ROSDiscourse',
    'stackoverflow_new_data.json': 'StackOverflow',
    'wiki_new_data.json': 'Wiki',
}
...
def main():
    ...
    print("Processing files from data/...")
